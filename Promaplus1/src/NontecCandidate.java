...
public class NontecCandidate extends javax.swing.JFrame {

    /**
     * Creates new form NontecCandidate
     */
    public NontecCandidate() {
        initComponents();
        CurrentDateTime();
    }
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(30, 105, 0, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NontecCandidate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NontecCandidate().setVisible(true);
            }
        });
    }
