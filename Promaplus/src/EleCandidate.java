...
public class EleCandidate extends javax.swing.JFrame {

    /**
     * Creates new form EleCandidate
     */
    public EleCandidate() {
        initComponents();
        CurrentDateTime();
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(30, 153, 0, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
           /*  for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
            ...
            java.util.logging.Logger.getLogger(EleCandidate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EleCandidate().setVisible(true);
            }
        });
    }
